...
- Se precisa de conexión de internet para instalar SAMBA, si no dispone de conexión debera de descargarlo manualmente
- La contraseña es P@ssw0rd, porfavor cambiela, al igual que el user que sera nasuser
- Revise cual es la unidad de disco que desea transformar al NAS, en el script por defecto es /dev/sdb
